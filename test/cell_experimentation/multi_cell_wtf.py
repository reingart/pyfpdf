...
doc.cell(w = 72 * 2, h = my_text_size * spacing, border = 1, ln = 2, txt = 'Lorem ipsum')
doc.cell(w = 72 * 2, h = my_text_size * spacing, border = 1, ln = 2, txt = 'Lorem ipsum')
# doc.multi_cell(w = 144, h = my_text_size * spacing, border = 1, txt = text[:50], fill = 0, link = '', ln = 0)
print(doc.get_x(), doc.get_y())
