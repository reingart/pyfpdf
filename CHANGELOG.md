...
- documentation on how to use `fpdf2` with [Flask](https://flask.palletsprojects.com) and [streamlit](https://streamlit.io/): [Usage in web APIs](https://pyfpdf.github.io/fpdf2/UsageInWebAPI.html)
### Fixed
