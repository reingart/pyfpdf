...
class FPDF:
    ...
    def ellipse(self, x, y, w, h, style=None):
        ...
        self._out(
            "{:.2f} {:.2f} m {:.2f} {:.2f} {:.2f} {:.2f} {:.2f} {:.2f} c".format(
                (cx + rx) * self.k,
                (self.h - cy) * self.k,
                (cx + rx) * self.k,
                (self.h - (cy - ly)) * self.k,
    ...
    def _putimage(self, info):
        if "data" in info:
            ...
            if "smask" in info:
                dp = (
                    f"/Predictor 15 /Colors 1 /BitsPerComponent 8 "
                    f"/Columns {info['w']}"
                )
                smask = {
                    "w": info["w"],
    ...
    def _dounderline(self, x, y, txt):
        ...
        return "{:.2f} {:.2f} {:.2f} {:.2f} re f".format(
            x * self.k,
